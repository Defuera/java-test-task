...
import ru.justd.testtask.index.model.MemoryCacheMembersDataSource;
import ru.justd.testtask.index.model.RetrofitMembersDataSource;
import ru.justd.testtask.index.model.MembersRepository;
import ru.justd.testtask.index.model.remote.FetchMemebersResponse;
import ru.justd.testtask.index.model.remote.FetchMemebersResponseDeserializer;
...
public class TestTaskModule {
    ...
    public TestTaskModule(Context context) {
